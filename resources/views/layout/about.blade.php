        ...
        <div class="row g-5 align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="author-inner">
                                <a class="thumbnail" href="#"><img
                                        src="{{ themeAsset('front', 'images/about/sm-01.png') }}"
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-2 order-md-1 order-sm-1 order-1">
                <div class="about-one-thumbnail">
                    <img src="{{ themeAsset('front', 'images/about/main/about-01.png') }}" alt="about-finbiz">
                    <img class="small-img" src="{{ themeAsset('front', 'images/about/main/about-02.png') }}"
                        alt="finbiz-small">
